...
type ReconcilerConfig struct {
	...
	OnCreate func(context.Context, ResourceWithLabels) error
	// OnUpdate is called when an existing resource is updated.
	OnUpdate func(context.Context, ResourceWithLabels) error
	// OnDelete is called when an existing resource is deleted.
	OnDelete func(context.Context, ResourceWithLabels) error
...
func (r *Reconciler) Reconcile(ctx context.Context, newResources []ResourceWithLabels) error {
...
func (r *Reconciler) processRegisteredResource(ctx context.Context, newResources ResourcesWithLabels, registered ResourceWithLabels) error {
...
func (r *Reconciler) processNewResource(ctx context.Context, new ResourceWithLabels) error {
